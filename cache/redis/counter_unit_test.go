...
func IncreaseFunction(impl cache.Counter) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("Increase:NotExists", func(t *testing.T) {
			...
			deleteErr := impl.(*accessor).Delete(context.Background(), key)
			if deleteErr != nil {
				t.Errorf("Increase:NotExists failed, delete error: %v", deleteErr)
			}

			result := impl.Increase(context.Background(), key, 1)
			...
			if result.GetValue() != 1 {
				t.Errorf("Increase:NotExists failed, incorrect result value: %d", result.GetValue())
			}
		})
		...
		t.Run("Increase:Exists", func(t *testing.T) {
			...
			impl.Increase(context.Background(), key, 1)
			result := impl.Increase(context.Background(), key, 1)
			if result == cache.CounterResultEnumFailed || result == cache.CounterResultEnumNotEffective {
		...
		t.Run("Increase:NotCounter", func(t *testing.T) {
			...
			storeErr := impl.(*accessor).Store(context.Background(), key, "NotCounter")
			if storeErr != nil {
...
func IncreaseWithExpireWhenNOtExistFunction(impl cache.Counter) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("IncreaseWithExpireWhenNotExist:NotExists", func(t *testing.T) {
			...
			result := impl.IncreaseWithExpireWhenNotExist(context.Background(), key, 1, expire)
			if result == cache.CounterResultEnumFailed || result == cache.CounterResultEnumNotEffective {
			...
			exist, expired, getErr := impl.(*accessor).GetExpiredTime(context.Background(), key)
			if getErr != nil {
		...
		t.Run("IncreaseWithExpireWhenNotExist:Concurrent", func(t *testing.T) {
			...
			impl.IncreaseWithExpireWhenNotExist(context.Background(), key, 1, expire*10)

			wg := sync.WaitGroup{}
			for i := 0; i < concurrentNum; i++ {
				wg.Add(1)
				go func() {
					impl.IncreaseWithExpireWhenNotExist(context.Background(), key, 1, expire)
					wg.Done()
				}()
			}
...
func SetExpireFunction(impl cache.Counter) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("SetExpire:NotExists", func(t *testing.T) {
			...
			result := impl.SetExpire(context.Background(), key, expire)
...
func SetExpireWhenNotSetFunction(impl cache.Counter) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("SetExpireWhenNotSet:NotExists", func(t *testing.T) {
			...
			result := impl.SetExpireWhenNotSet(context.Background(), key, expire)
			if result != cache.CounterResultEnumNotEffective {
		...
		t.Run("SetExpireWhenNotSet:ExistsWithExpired", func(t *testing.T) {
			...
			impl.IncreaseWithExpireWhenNotExist(context.Background(), key, 1, expire1)
			result := impl.SetExpireWhenNotSet(context.Background(), key, expire2)
			if result != cache.CounterResultEnumNotEffective {
...
func ExpireImmediatelyFunction(impl cache.Counter) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("ExpireImmediately:NotExists", func(t *testing.T) {
			...
			result := impl.ExpireImmediately(context.Background(), key)
			if result != cache.CounterResultEnumNotEffective {
