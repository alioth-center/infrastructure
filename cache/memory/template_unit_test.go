...
func ExistKeyTestFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("ExistKey:NotExpired", func(t *testing.T) {
			...
			storeErr := impl.StoreEX(context.Background(), key, "ExistKey:NotExpired", time.Second)
			if storeErr != nil {
		...
		t.Run("ExistKey:Expired", func(t *testing.T) {
			...
			storeErr := impl.StoreEX(context.Background(), key, "ExistKey:Expired", time.Nanosecond)
			if storeErr != nil {
...
func GetExpiredTimeFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("GetExpiredTime:Expired", func(t *testing.T) {
			...
			storeErr := impl.StoreEX(context.Background(), key, "GetExpiredTime:Expired", time.Nanosecond)
			if storeErr != nil {
...
func LoadFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("Load:Expired", func(t *testing.T) {
			key := "Load:Expired"
			storeErr := impl.StoreEX(context.Background(), key, "Load:Expired", time.Nanosecond)
			if storeErr != nil {
		...
		t.Run("Load:NotString", func(t *testing.T) {
			...
			exist, loadedValue, loadErr := impl.Load(context.Background(), key)
			wantErr := NewValueTypeNotMatchError(String, Set)
			if loadErr == nil {
				t.Errorf("Load:NotString case failed: want error but not")
			}
			if !errors.As(loadErr, &wantErr) {
				t.Errorf("Load:NotString case failed: incorrect error")
			}
			if !exist {
				t.Errorf("Load:NotString case failed: key not exist, want exist")
			}
			if loadedValue != "" {
...
func LoadWithEXFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("LoadWithEX:Expired", func(t *testing.T) {
			...
			storeErr := impl.StoreEX(context.Background(), key, "LoadWithEX:Expired", time.Nanosecond)
			if storeErr != nil {
...
func LoadJsonFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("LoadJson:Expired", func(t *testing.T) {
			...
			storeErr := impl.StoreJsonEX(context.Background(), key, value, time.Nanosecond)
			if storeErr != nil {
...
func StoreFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("Store:Expired", func(t *testing.T) {
			...
			storePrevErr := impl.StoreEX(context.Background(), prevKey, "Store:Expired:Prev", time.Nanosecond)
			if storePrevErr != nil {
		...
		t.Run("Store:NotString", func(t *testing.T) {
			...
			if addErr != nil {
				t.Errorf("Store:NotString case failed when storing key: %v", addErr.Error())
			}

			storeErr := impl.Store(context.Background(), key, value)
			wantErr := NewValueTypeNotMatchError(String, Set)
			if storeErr == nil {
				t.Errorf("Store:NotString case failed: want error but not")
			}
			if !errors.As(storeErr, &wantErr) {
				t.Errorf("Store:NotString case failed: incorrect error")
			}
		})
	}
}
...
func StoreEXFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("StoreEX:Expired", func(t *testing.T) {
			...
			storePrevErr := impl.StoreEX(context.Background(), prevKey, "StoreEX:Expired:Prev", time.Nanosecond)
			if storePrevErr != nil {
...
func StoreJsonFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("StoreJson:Expired", func(t *testing.T) {
			...
			storePrevErr := impl.StoreJsonEX(context.Background(), prevKey, prevValue, time.Nanosecond)
			if storePrevErr != nil {
...
func LoadOrStoreFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("LoadOrStore:Expired", func(t *testing.T) {
			...
			storeErr := impl.StoreEX(context.Background(), key, "LoadOrStore:Expired:Prev", time.Nanosecond)
			if storeErr != nil {
...
func LoadOrStoreEXFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("LoadOrStoreEX:Expired", func(t *testing.T) {
			...
			storeErr := impl.StoreEX(context.Background(), key, "LoadOrStoreEX:Expired:Prev", time.Nanosecond)
			if storeErr != nil {
...
func LoadOrStoreJsonEXFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("LoadOrStoreJsonEX:Expired", func(t *testing.T) {
			...
			prevValue, value := testStruct{Key: key, Value: key + ":Prev"}, testStruct{Key: key, Value: key}
			storePrevErr := impl.StoreJsonEX(context.Background(), key, prevValue, time.Nanosecond)
			if storePrevErr != nil {
...
func IsMemberFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("IsMember:Expired", func(t *testing.T) {
			...
			expireErr := impl.Expire(context.Background(), key, time.Nanosecond)
			if expireErr != nil {
		...
		t.Run("IsMember:WrongType", func(t *testing.T) {
			...
			wantError := NewValueTypeNotMatchError(Set, String)
			if !errors.As(err, &wantError) {
				t.Errorf("IsMember:WrongType case failed: incorrect error")
			}
			if exist {
...
func AddMemberFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("AddMember:WrongType", func(t *testing.T) {
			...
			wantError := NewValueTypeNotMatchError(Set, String)
			if !errors.As(executeErr, &wantError) {
				t.Errorf("AddMember:WrongType case failed: incorrect error")
			}
		})
	}
}
...
func AddMembersFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("AddMembers:WrongType", func(t *testing.T) {
			...
			wantError := NewValueTypeNotMatchError(Set, String)
			if !errors.As(executeErr, &wantError) {
				t.Errorf("AddMembers:WrongType case failed: incorrect error")
			}
		})
	}
}
...
func RemoveMemberFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("RemoveMember:WrongType", func(t *testing.T) {
			...
			wantError := NewValueTypeNotMatchError(Set, String)
			if !errors.As(executeErr, &wantError) {
				t.Errorf("RemoveMember:WrongType case failed: incorrect error")
			}
		})
	}
}
...
func GetMembersFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("GetMembers:WrongType", func(t *testing.T) {
			...
			wantError := NewValueTypeNotMatchError(Set, String)
			if !errors.As(getMembersErr, &wantError) {
				t.Errorf("GetMembers:WrongType case failed: incorrect error")
			}
			if getMembers == nil {
...
func GetRandomMembersFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("GetRandomMembers:WrongType", func(t *testing.T) {
			...
			wantError := NewValueTypeNotMatchError(Set, String)
			if !errors.As(getRandomMembersErr, &wantError) {
				t.Errorf("GetRandomMembers:WrongType case failed: incorrect error")
			}
			if gotMembers == nil {
...
func HGetValueFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("HGetValue:FieldNotExist", func(t *testing.T) {
			...
			if !exist {
				t.Errorf("HGetValue:FieldNotExist case failed: key not exist, want exist")
			}
			if getValue != "" {
		...
		t.Run("HGetValue:WrongType", func(t *testing.T) {
			...
			wantError := NewValueTypeNotMatchError(Hash, String)
			if !errors.As(getValueErr, &wantError) {
				t.Errorf("HGetValue:WrongType case failed: incorrect error")
			}
			if !exist {
				t.Errorf("HGetValue:WrongType case failed: key not exist, want exist")
			}
			if value != "" {
...
func HGetValuesFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("HGetValues:WrongType", func(t *testing.T) {
			...
			wantError := NewValueTypeNotMatchError(Hash, String)
			if !errors.As(getValuesErr, &wantError) {
				t.Errorf("HGetValues:WrongType case failed: incorrect error")
			}
			if getValues == nil {
...
func HSetValueFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("HSetValue:WrongType", func(t *testing.T) {
			...
			wantError := NewValueTypeNotMatchError(Hash, String)
			if !errors.As(setValueErr, &wantError) {
				t.Errorf("HSetValue:WrongType case failed: incorrect error")
			}
		})
	}
}
...
func HSetValuesFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("HSetValues:WrongType", func(t *testing.T) {
			...
			wantError := NewValueTypeNotMatchError(Hash, String)
			if !errors.As(setValuesErr, &wantError) {
				t.Errorf("HSetValues:WrongType case failed: incorrect error")
			}
		})
	}
}
...
func HRemoveValueFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("HRemoveValue:NotExpired", func(t *testing.T) {
			...
			if !exist {
				t.Errorf("HRemoveValue:NotExpired case failed: key not exist, want exist")
			}
			if getValue != "" {
		...
		t.Run("HRemoveValue:WrongType", func(t *testing.T) {
			...
			wantError := NewValueTypeNotMatchError(Hash, String)
			if !errors.As(removeValueErr, &wantError) {
				t.Errorf("HRemoveValue:WrongType case failed: incorrect error")
			}
		})
	}
}
...
func HRemoveValuesFunction(impl cache.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("HRemoveValues:WrongType", func(t *testing.T) {
			...
			wantError := NewValueTypeNotMatchError(Hash, String)
			if !errors.As(removeValuesErr, &wantError) {
				t.Errorf("HRemoveValues:WrongType case failed: incorrect error")
			}
		})
	}
}
